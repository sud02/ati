...
const ExchangePolicy = () => {
    return (
        <div className="exchange-policy-container">
            ...
            <p className="policy-text">
                IF A SIZE EXCHANGE CANNOT BE COMPLETED DUE TO STOCK LIMITATIONS, WE WILL EITHER OFFER AN ALTERNATIVE PRODUCT OR ISSUE STORE CREDIT, WHICH CAN BE USED AT ANY OF OUR THREE STORES OR ON YOUR NEXT ONLINE PURCHASE.
            </p>
            <p className="policy-text">
            ...
            <p className="policy-text">
                CANCELLATIONS ARE ONLY AVAILABLE FOR CASH ON DELIVERY (COD) ORDERS AND CAN ONLY BE PROCESSED IF THE ORDER HAS NOT BEEN DISPATCHED FROM OUR WAREHOUSE. PREPAID ORDERS ARE FINAL AND NON-REFUNDABLE. HOWEVER, REFUNDS FOR PREPAID ORDERS WILL BE ISSUED AS STORE CREDIT, EQUIVALENT TO THE SELLING PRICE OR MRP, AND MUST BE USED WITHIN THREE MONTHS. STORE CREDITS ARE NON-REFUNDABLE AND CAN BE REDEEMED ONLY IN OUR PHYSICAL STORES OR ONLINE. SHIPPING CHARGES ARE NON-REFUNDABLE.
            </p>
